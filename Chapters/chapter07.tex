...
The next observation was that even though the beacons were set to transmit at the lowest possible signal strength...\todo{Create good sentence}
...
\todo{Write how we dealt with this}
