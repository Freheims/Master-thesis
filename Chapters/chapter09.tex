...
To get precision tracking one would need a system such as the one described by ??\todo{referanse} (summarized in Chapter ??\todo{ref til kap 2}), which is not a solution that can be moved around.
