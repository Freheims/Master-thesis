...
To meet this need for information about firefighters movement in a smoke filled building a system for tracking them while they train was created using Bluetooth Low Energy (BLE) beacons and smartphones to track the firefighters and visualize the data about their movements. 
...
\section{Motivation}
The motivation for doing this masters project is that there is a need for a tool such as this.
...
This research is part of the iComPAss project.
...
Together we developed the FireTracker system, which comprises an admin interface\todo{Agree with Edvard on a 'name'}, an android application, and a back end.
